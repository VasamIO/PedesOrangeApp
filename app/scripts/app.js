'use strict';
var baseUrl = 'http://telidos.pedesorangecounty.com/api/', isDebugEnabled = true;
var fileUploadUrl = 'http://telidos.pedesorangecounty.com/service/aservice';
...
app.service('Menu', ['$location', function ($location) {
	...
	items = [{code:'phyform', icon:'icon-building', name:'Referral Form',cls:'icon',style:'background:'},{code:'refform', icon:'icon-copy', name:'Referrals',cls:'icon',style:''}];
